...
Pod::Spec.new do |spec|
  ...
  spec.name         = "Profile"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of Profile."
  ...
  spec.description  = "Profile module for development"

  spec.homepage     = "http://www.song.com/Profile"
